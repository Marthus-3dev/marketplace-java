...
import com.marthus.marketplace.model.Usuario;
import com.marthus.marketplace.model.UsuarioDAO;
import com.marthus.marketplace.util.Constantes;
...
public class CadastroController {
    ...
    protected  void aoConfirmarCadastro(ActionEvent event) throws IOException {
        ...
        if(senha.isBlank() | !usuario.matches(Constantes.REGEX_SENHA.getValor())){
